						...
						items: {
							...
							properties: {
								search_str: {
									...
									type: "string",
									description:
										"The exact content to search for, including whitespace and indentation. This must match the original content exactly.",
									required: true,
								},
								replace_str: {
									name: "replace_str",
									type: "string",
									description:
										"The new content to replace the old content with. This should maintain proper indentation and structure.",
									required: true,
								},
								start_line: {
									name: "start_line",
